	...
	static {
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Entry, Object>() {
				...
				public void accept(Entry entry, Object statusObject) {
					entry.setStatus((Integer)statusObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Entry, Object>() {
				...
				@Override
				public void accept(Entry entry, Object statusByUserIdObject) {
					entry.setStatusByUserId((Long)statusByUserIdObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Entry, Object>() {
				...
				@Override
				public void accept(Entry entry, Object statusByUserNameObject) {
					entry.setStatusByUserName((String)statusByUserNameObject);
				}
		...
		attributeSetterBiConsumers.put(
			...
			new BiConsumer<Entry, Object>() {
				...
				@Override
				public void accept(Entry entry, Object statusDateObject) {
					entry.setStatusDate((Date)statusDateObject);
				}
